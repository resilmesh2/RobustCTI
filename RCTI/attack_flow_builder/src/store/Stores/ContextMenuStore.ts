...
export default {
    ...
    getters: {
        ...
        openFileMenu(_s, _g, rootState): ContextMenuSection {
            ...
            return {
                ...
                items: [
                    ...
                    {
                        text: "New IoB Attackflow",
                        type: MenuType.Item,
                        data: () => App.PrepareEditorWithFile.fromNewIoB(ctx),
                    },
                    {
                        text: `Open File...`,
                        type: MenuType.Item,
         ...
         *  The tool menu.
         */
        toolMenu(_s, getters): ContextMenu {
            return {
                text: "Tool",
                type: MenuType.Submenu,
                sections: [
                    getters.integrationToolsMenu
                ]
            }
        },

        /**
         * Returns the integration tools menu section.
         * @param _s
         *  The Vuex state. (Unused)
         * @param _g
         *  The Vuex getters. (Unused)
         ...
         *  The Vuex root state.
         * @returns
         *  The integration tools menu section.
         */
        integrationToolsMenu(_s, _g, rootState): ContextMenuSection {
            let ctx = rootState.ApplicationStore;
            return {
                ...
                items: [
                    {
                        ...
                        type: MenuType.Item,
                        data: () => new App.ShowIntegrationToolsDialog(ctx)
                    }
                ]
            };
        }
