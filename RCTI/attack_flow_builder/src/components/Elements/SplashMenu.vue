    ...
    <div class="menu-body">
      ...
      <div class="section open-file">
        ...
        <div class="button-grid">
          ...
          <div class="button" @click="onNewIoBFile">
            <div class="button-header">
              <span class="button-icon"><EmptyPage /></span>
              <p class="button-title">{{ newIoBFile.title }}</p>
            </div>
            <p class="button-description">{{ newIoBFile.description }}</p>
          </div>
...
export default defineComponent({
  ...
  methods: {
    ...
    /**
     * New IoB File behavior.
     */
    async onNewIoBFile() {
      this.execute(await App.PrepareEditorWithFile.fromNewIoB(this.context));
    },
